...
4. What does the command `docker ps` do?  
   ...
   Explanation: I tested the command in docker Hub and it displays me all the images details such as which port is it using, the date it was created, status.
